...
CUIThreadDlg::CUIThreadDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CUIThreadDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CUIThreadDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON_UI_THREAD, &CUIThreadDlg::OnBnClickedButtonUiThread)
END_MESSAGE_MAP()
...
void CUIThreadDlg::OnBnClickedButtonUiThread()
{
