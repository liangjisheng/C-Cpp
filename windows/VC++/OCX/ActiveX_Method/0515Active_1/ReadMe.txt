========================================================================
    ACTIVEX CONTROL DLL : 0515Active_1 Project Overview
========================================================================

ControlWizard has created this project for your 0515Active_1 ActiveX Control
...
that make up your 0515Active_1 ActiveX Control DLL.

0515Active_1.vcxproj
...
0515Active_1.ico
    ...
    is included by the main resource file 0515Active_1.rc.

/////////////////////////////////////////////////////////////////////////////
CMy0515Active_1Ctrl control:

0515Active_1Ctrl.h
    This file contains the declaration of the CMy0515Active_1Ctrl C++ class.

0515Active_1Ctrl.cpp
    This file contains the implementation of the CMy0515Active_1Ctrl C++ class.

0515Active_1PropPage.h
    This file contains the declaration of the CMy0515Active_1PropPage C++ class.

0515Active_1PropPage.cpp
    This file contains the implementation of the CMy0515Active_1PropPage C++ class.

CMy0515Active_1Ctrl.bmp
    This file contains a bitmap that a container will use to represent the
    CMy0515Active_1Ctrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file 0515Active_1.rc.
...
stdafx.h, stdafx.cpp
    ...
    named 0515Active_1.pch and a precompiled types (PCT) file named stdafx.obj.
