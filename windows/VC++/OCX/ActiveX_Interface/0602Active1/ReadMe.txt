========================================================================
    ACTIVEX CONTROL DLL : 0602Active1 Project Overview
========================================================================

ControlWizard has created this project for your 0602Active1 ActiveX Control
...
that make up your 0602Active1 ActiveX Control DLL.
...
0602Active1.ico
    ...
    is included by the main resource file 0602Active1.rc.

/////////////////////////////////////////////////////////////////////////////
CMy0602Active1Ctrl control:

0602Active1Ctrl.h
    This file contains the declaration of the CMy0602Active1Ctrl C++ class.

0602Active1Ctrl.cpp
    This file contains the implementation of the CMy0602Active1Ctrl C++ class.

0602Active1PropPage.h
    This file contains the declaration of the CMy0602Active1PropPage C++ class.

0602Active1PropPage.cpp
    This file contains the implementation of the CMy0602Active1PropPage C++ class.

CMy0602Active1Ctrl.bmp
    This file contains a bitmap that a container will use to represent the
    CMy0602Active1Ctrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file 0602Active1.rc.
...
stdafx.h, stdafx.cpp
    ...
    named 0602Active1.pch and a precompiled types (PCT) file named stdafx.obj.
