...
BEGIN_MESSAGE_MAP(CBmpTreeDlg, CDialog)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_NOTIFY(TVN_ITEMEXPANDING, IDC_CUSTOM_TREE, OnItemexpandingCustomTree)
	ON_NOTIFY(TVN_ITEMEXPANDED, IDC_CUSTOM_TREE, OnItemexpandedCustomTree)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
void CBmpTreeDlg::OnItemexpandingCustomTree(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
void CBmpTreeDlg::OnItemexpandedCustomTree(NMHDR* pNMHDR, LRESULT* pResult) 
{
	NM_TREEVIEW* pNMTreeView = (NM_TREEVIEW*)pNMHDR;
	SetRedraw(TRUE);
